...
int main() {
	...
	case 1: {
		...
		const string stringArray[] = {convertPolynomial(newPolynomial), Utilities::fraction(a, 0.0001), Utilities::fraction(b, 0.0001), Utilities::convertDouble(answer), convertInt(numberOfColumns)};
	...
	case 3: {
		...
		const string stringArray[] = {convertPolynomial(newPolynomial), Utilities::fraction(a, 0.0001), Utilities::fraction(b, 0.0001), Utilities::convertDouble(answer)};
