...
public class IntegrationMain {
	public static void main(String[] args) {
		...
		do {
			...
			int index = 0;
			MessageFormat messageFormat = new MessageFormat(propertiesFile.getPropertyValue("ASK_FOR_COEFFICIENT"));
			while(index <= degree) {
				double coe;
			...
			int choosenMethod = 0;
			messageFormat = new MessageFormat("\n" + propertiesFile.getPropertyValue("ASK_FOR_INTEGRATION_METHOD"));
			...
			switch(choosenMethod) {
				case 1:
					do {
					n = Utilities.validateInt(keyboard, "\n" + propertiesFile.getPropertyValue("ASK_FOR_N"), 
						propertiesFile.getPropertyValue("INVALID_POSITIVE_INTEGER"));
					} while(n <= 0);
					answer = IntegrationMethods.rectangleMethod(a, b, n, polynomial);
					stringArrayParams = new String[]{polynomial.toString(), "" + a, "" + b, "" + answer, "" + n};
				...
				case 2:
					...
					stringArrayParams = new String[]{polynomial.toString(), "" + a, "" + b, "" + answer, "" + n};
					messageFormat = new MessageFormat(propertiesFile.getPropertyValue("SOLVE_TRAPEZOIDAL"));
					System.out.println("\n" + messageFormat.format(stringArrayParams));
					break;
				case 3:
					...
					messageFormat = new MessageFormat("\n" + propertiesFile.getPropertyValue("SHOW_INTEGRAL"));
					System.out.println(messageFormat.format(stringArrayParams));
					break;
				default:
					System.out.println("\n" + propertiesFile.getPropertyValue("INVALID_POSITIVE_INTEGER"));
